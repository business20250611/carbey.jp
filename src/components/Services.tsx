...
const Services: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section
        className="h-[400px] lg:h-[500px] text-white relative flex items-end"
        style={{
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8 text-center pb-16">
          ...
          <p className="text-xl text-white drop-shadow-[0_4px_8px_rgba(0,0,0,0.8)]" style={{ textShadow: '2px 2px 8px rgba(0,0,0,0.9), 0 0 20px rgba(0,0,0,0.6)' }}>
            事業内容
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                データ分析と自動売買システムを活用し、車両保管や管理まですべて一元管理。
